...
// { type: "WITHDRAWL_FROM_BANK", payload }
...
export const withdrawlFromBank = (payload) => ({
  type: "WITHDRAWL_FROM_BANK",
  payload
});

export const depositToBank = (payload) => ({
  type: "DEPOSIT_TO_BANK",
  payload
});

export const fine = () => ({
  type: "FINE_BANK_ACCOUNT",
  payload: 2500
});
